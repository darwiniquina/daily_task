...
<template>
  <div class="w-full pb-6 pt-2 outline-none">
    <div class="w-full p-4 sm:p-8 bg-white/40 backdrop-blur-xl rounded-[32px] sm:rounded-[40px] border border-white shadow-xl shadow-blue-900/5 overflow-hidden">
      <div class="flex flex-col gap-4">
        
        <!-- Headers -->
        <div class="flex items-end justify-between px-2 mb-2 overflow-hidden">
           <div class="flex gap-1 items-baseline shrink-0">
             <span class="text-2xl sm:text-3xl font-black text-gray-900 tracking-tighter">Energy Map</span>
             <span class="hidden sm:inline text-xs font-bold text-gray-400 uppercase tracking-widest ml-2">Momentum</span>
           </div>
        </div>
        ...
        <div class="flex flex-col gap-1 sm:gap-2">
           ...
           <div class="grid grid-rows-7 grid-flow-col grid-cols-[20px_repeat(53,minmax(0,1fr))] gap-1 sm:gap-1.5 px-1 sm:px-2">
             <!-- Column 0: Day Labels -->
             <div class="text-[8px] sm:text-[9px] text-gray-300 font-black uppercase flex items-center justify-center">S</div>
             <div class="text-[8px] sm:text-[9px] text-gray-300 font-black uppercase flex items-center justify-center">M</div>
             <div class="text-[8px] sm:text-[9px] text-gray-300 font-black uppercase flex items-center justify-center">T</div>
             <div class="text-[8px] sm:text-[9px] text-gray-300 font-black uppercase flex items-center justify-center">W</div>
             <div class="text-[8px] sm:text-[9px] text-gray-300 font-black uppercase flex items-center justify-center">T</div>
             <div class="text-[8px] sm:text-[9px] text-gray-300 font-black uppercase flex items-center justify-center">F</div>
             <div class="text-[8px] sm:text-[9px] text-gray-300 font-black uppercase flex items-center justify-center">S</div>
                 ...
                 <Tooltip>
                   ...
                   <TooltipContent class="rounded-xl border-none shadow-2xl bg-gray-900 text-white p-3">
                     <div class="flex flex-col items-center gap-1">
                       <span class="text-xs font-black text-blue-400 uppercase tracking-tighter">{{ day.date ? format(day.date, 'MMM d, yyyy') : '' }}</span>
      ...
      <div class="flex flex-wrap items-center gap-3 sm:gap-4 mt-6 sm:mt-8 justify-center">
        <span class="text-[9px] sm:text-[10px] text-gray-400 font-bold uppercase tracking-widest whitespace-nowrap">Growth Scale</span>
        ...
        <span class="text-[9px] sm:text-[10px] text-gray-400 font-bold uppercase tracking-widest whitespace-nowrap">Peak</span>
      </div>
    </div>
  </div>
</template>
